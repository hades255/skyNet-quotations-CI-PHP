    ...
    <div class='form-content form-div'>
        ...
        <div class="table-bordered">
            ...
            foreach ($fields as $field) {
                ...
                $counter++;
                ?>
                <div class='form-field-box d-flex justify-content-between  '
        ...
        <div class='buttons-box'>
            ...
            <?php if (!$this->unset_back_to_list) { ?>
                <div class='form-button-box'>
                    <input type='button' value='<?php echo $this->l('form_update_and_go_back'); ?>'
                           class='btn btn-raised btn-info' id="save-and-go-back-button"/>
                </div>
                <div class='form-button-box'>
                    <input type='button' value='<?php echo $this->l('form_cancel'); ?>' class='btn btn-raised btn-info'
                           id="cancel-button"/>
                </div>
            <?php } ?>
