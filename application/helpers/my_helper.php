...
function _exec_curl($url_temp, $filename, $path, $html = '') {
...
function _is_lower_admin() {

	$CI = get_instance();

	if ($CI->user->info->user_role == 2) {
...
function _is_vehicle() {

	$CI = get_instance();

	if ($CI->user->info->user_role == 4) {
