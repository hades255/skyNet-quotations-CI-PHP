...
*/
	...
	function pdf($cotizacion_id, $save = false)
	{
		...
		$pdf->Output($_SERVER['DOCUMENT_ROOT'] . "/uploads/pdf/" . $file, 'F');

		//          require_once APPPATH . 'vendor/autoload.php';
		require APPPATH . 'third_party/PHPMailer2/src/Exception.php';
		require APPPATH . 'third_party/PHPMailer2/src/PHPMailer.php';
		require APPPATH . 'third_party/PHPMailer2/src/SMTP.php';

		$mail = new PHPMailer(); // Enable verbose debug output

		$mail->isSMTP();
		$mail->Host = 'mail.transportesdedicados.com.mx';
		$mail->SMTPAuth = true;
		$mail->Username = 'clientes@transportesdedicados.com.mx';
		$mail->Password = 'GD2[Y3wxm;O1';
		$mail->SMTPSecure = 'ssl';
		$mail->Port = 465;
		$mail->setFrom('clientes@transportesdedicados.com.mx', 'noreply');
		$email = _info('email', $cotizacion[0], true);

		$mail->addAddress($email, $cotizacion[0]->creador_nombre . " " . $cotizacion[0]->$creador_apellido);
		$mail->Subject = 'Email with Attachment';
		$mail->Body = 'This is the body of the email.';

		$attachmentFilePath = 'home/disenoweb/test.diseno-web.mx/uploads/pdf/' . $cotizacion_id . '.pdf';
