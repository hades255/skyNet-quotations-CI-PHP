...
<!--          type="text/css">-->
    ...
    <script type='text/javascript' src='https://platform-api.sharethis.com/js/sharethis.js#property=64a4cf701e26290019413cf6&product=sop' async='async'></script>
...
<!--    <script src="--><?php //echo base_url() ?><!--assets/theme/js/jquery.min.js"></script>-->
    ...
    <?php  
        ...
        if(strpos($url,'vehiculos/add') !== false){
        ?>   
            <script src="<?php echo base_url(); ?>node_modules\jquery\dist/cdn/jquery-2.1.1.min.js"></script>
            <script>
                $.noConflict()
...
<?php  
        ...
        if(strpos($url,'vehiculos/add') == true){
        ?>
        ...
        <div class="content">
            ...
            <div class="topbar">
                <nav class="navbar-custom">
                    <div class="dropdown notification-list nav-pro-img float-center">
                        <div class="list-inline-item hide-phone app-search">
                            <h4 style="color: white; vertical-align: center; font-family: 'tinymce-small', Arial">Dedicated transport service</h4>
                        </div>
                    </div>
