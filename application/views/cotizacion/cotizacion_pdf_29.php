...
<!--                At'n --><?php //echo $nombre; ?><!-- / --><?php //echo $empresa; ?><!-- / --><?php //echo $telefono; ?><!--</strong><br/>-->
            <span class="Estilo12">Cotizaci&oacute;n #: <?php echo $cotizacion_id; ?></span>&nbsp; <?php echo $empresa; ?>  <?php echo $telefono; ?><br/>
            <div id="card">
                <table>
            ...
            <table id="detalles" style="border: solid 1px #0096ff; width: 100%;" padding="0" width="100%"
                ...
                <tr style="background-color: #0096ff; border:solid 1px #0096ff;">
                    ...
                    <td style="color:#FFFFFF; font-weight:bold;">$<?PHP echo $importe_total; ?> MXN + IVA
                    </td>
                </tr>
            </table>
            <p></p>
            <img src="https://www.transportesdedicados.com/uploads/settings/cuentas.jpg" alt="" width="500" height="40">
            <div class="Estilo11">
