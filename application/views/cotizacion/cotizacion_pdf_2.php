...
$custody_importe = _info('custody_importe', $cotizacion_info, true);
...
//$user_firstname = _info('user_firstname', $cotizacion_info, true);
//$user_lastname = _info('user_lastname', $cotizacion_info, true);
//$user_phone = _info('user_phone', $cotizacion_info, true);
//print_r($user_firstname);
//return;
$user_firstname = $this->user->info->first_name;
$user_lastname = $this->user->info->last_name;
$user_phone = $this->user->info->phone;
//print_r($user_firstname);
//return;

//$vehiculo_price = 20;

$maniobras_importe = floatval($maniobras_importe);
$kilometros = floatval($kilometros);
$vehiculo_price = floatval($vehiculo_price);
$custody_importe = floatval($custody_importe);
$importe = floatval($importe);
$peso_embarque = _f(floatval($peso_embarque));
//                                $importe_total = $importe_total;
//$prima = floatval($prima);
//$importe = _f(floatval($importe));

// $kilometro = _f($kilometros);
// $vehiculo_pric = _f($vehiculo_price);

$declarar_valor = floatval($declarar_valor);
$declarar_valor_val = floatval($declarar_valor_val);

// $importe = $vehiculo_price * $kilometros;
//                                printf($importe);return;
//                                $importe = _f(floatval($importe));
...
// print_r($importe);
// return;
$importe_total = _f(($importe + $declarar_amount + $maniobras_importe + $custody_importe) * 1.16);
$importe = _f($importe);
$custody_importe = _f($custody_importe);

$maniobras_importe = _f(floatval($maniobras_importe));
//                                printf(this->$cotizacion_id);
//                                printf($importe );
//                                printf($declarar_amount );
//                                printf($custody_importe );
//                                return;
                        ...
                        <tr style="padding: 20px">
                            ...
                            <td style="height:100%; padding: 20px;">
                                <img src="<?php echo base_url("uploads/vehiculos/" . $vehiculo_logo); ?>" alt=""
                                     height="220px" style="float:right; ">
                            </td>
                        </tr>
                    </table>
                </div>
                <br/>
                <table id="detalles" style="border: solid 1px #0096ff; width: 100%;" padding="0" width="100%"
                       cellpadding="5" cellspacing="0">
                    <tr>
                        <td style="border: solid 1px #0096ff;">Tipo de Unidad:</td>
                        <td style="border: solid 1px #0096ff;"><?php echo $vehiculo_tipo_unidad; ?>
                        </td>
                    </tr>
                    <tr>
                        <td style="border: solid 1px #0096ff;">Origen</td>
                        <td style="border: solid 1px #0096ff;"><?php echo $origen; ?></td>
                    </tr>
                    <tr>
                        <td style="border: solid 1px #0096ff;">Destino</td>
                        <td style="border: solid 1px #0096ff;"><?php echo $destino; ?></td>
                    </tr>
                    <tr>
                        <td style="border: solid 1px #0096ff;">Descripción de la Carga</td>
                        <td style="border: solid 1px #0096ff;"><?php echo $descripcion; ?></td>
                    </tr>
                    <tr>
                        <td style="border: solid 1px #0096ff;">Peso por Embarque</td>
                        <td style="border: solid 1px #0096ff;"><?php echo $peso_embarque; ?><?php echo $peso_embarque_dimension; ?></td>
                    </tr>
                    <tr>
                        <td style="border: solid 1px #0096ff;">Kilómetros</td>
                        <td style="border: solid 1px #0096ff;"><?php echo $kilometros; ?>
                        </td>
                    </tr>
                    <tr>
                        <td style="border: solid 1px #0096ff;">Importe del Servicio</td>
                        <td style="border: solid 1px #0096ff;">$<?php echo $importe; ?></td>
                    </tr>
                 
                        <tr>
                            <td style="border: solid 1px #0096ff;">Custody service</td>
                            <td style="border: solid 1px #0096ff;">$<?php echo $custody_importe; ?></td>
                        </tr>
             
                        <tr>
                            <td style="border: solid 1px #0096ff;">Maniobras Liquidación 100% Anticipado</td>
                            <td style="border: solid 1px #0096ff;">$<?php echo $maniobras_importe; ?></td>
                        </tr>
                   
                    <tr>
                        <td style="border: solid 1px #0096ff;">Fecha del Servicio</td>
                        <td style="border: solid 1px #0096ff;"><?php echo _fecha_literal($fecha_a); ?></td>
                    </tr>
                    <tr>
                        <td style="border: solid 1px #0096ff;">Valor Declarado por Cliente</td>
                        <td style="border: solid 1px #0096ff;">
		        <span>Valor declarado: </span>$<?php echo $declarar_valor_val; ?>&nbsp;/&nbsp;
                            <span>Costo del seguro: </span>$<?php echo $declarar_amount; ?>
                        </td>
                    </tr>
                    <tr style="background-color: #0096ff; border:solid 1px #0096ff;">
                        <td style="color:#FFFFFF; font-weight:bold;">Disposición Inmediata Total</td>
                        <td style="color:#FFFFFF; font-weight:bold;">$<?PHP echo $importe_total; ?> MXN con IVA incluido.
                        </td>
                    </tr>
                </table>
                <p></p>
                <img src="https://www.transportesdedicados.com/uploads/settings/cuentas.jpg" alt="" width="500"
                     height="40">
                <div class="Estilo11">
                    <p>
                        <strong>
                        	<?php if ($maniobras_importe == 0) { ?>No se incluyen maniobras de carga y descarga.
		 	<?php }else{ ?>Se incluye servicio de maniobras de carga y descarga.
                            	<?php } ?>
                        </strong>
                 <br />
                        <strong>
                            <?php if ($custody_importe == 0) { ?>
No se incluye servicio de custodia.
                            <?php }else{ ?>
Se incluye servicio de custodia armada.
                            <?php } ?>
                        </strong>
                  <br />
                        <strong>
                            	<?php if ($declarar_amount == 0) { ?>
Valor de carga no declarada, no se incluye seguro de mercancía.
                            	<?php }else{ ?>
Esta cotización incluye seguro de mercancía.
			<?php } ?>          
                        </strong>
                    </p>
                    <p>Este servicio incluye: Servicio de flete con Operador, Recolecci&oacute;n y Entrega.
                        ...
                        la mercanc&iacute;a alcanza a tener un valor de m&aacute;s de un Mill&oacute;n de Pesos M.N., se
                        le
                        manejar&iacute;a costo preferencial del porcentaje antes
                        mencionado. * En valores declarados iguales o inferiores a $350,000.00 M.N el costo del seguro
                        ser&aacute;
                        de $3,500.00 M.N. + IVA<br/>Confirmaci&oacute;n de servicio con 24 Horas de anticipaci&oacute;n
                        de
                        preferencia; o bien si requiere FLETE URGENTE contamos con disposici&oacute;n inmediata. Los
                        tiempos de entrega est&aacute;n sujetos a imprevistos fuera de nuestro alcance como lo puede
                        ser:
                        Retenes Federales, Condiciones Climatol&oacute;gicas o
                        imprevistos de &uacute;ltimo momento.<br/>
                        <br/>
                        <strong>Condiciones de Pago:<br/>
                            1) 100% Anticipado en servicios locales, en productos perecederos o productos
                            peligrosos.<br/>
                        ...
                        <strong>Forma de Pago: Transferencia Electr&oacute;nica Interbancaria o Dep&oacute;sito en Firme
                            en
        ...
        <div class="page page-condiciones Estilo10">
            ...
            <h3 style="text-align: center;">CONDICIONES DEL CONTRATO DE TRANSPORTE QUE AMPARA ESTA CARTA PORTE</h3>

            <p><strong>PRIMERA.-</strong> Para los efectos del presente contrato de transporte se denomina &quot;Porteador&quot;
